...
**Reaver YOLO-Deploy** is back. Last time, in [Mission 2.1](https://github.com/starfall-defence-corps/mission-2-1-weapon-handling-test), YOLO-Deploy pushed untested code to production. Friday. 16:59. Three nodes down. You built tests to catch it.
